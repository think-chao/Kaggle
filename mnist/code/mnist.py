...
train_x = train_data[:int(total * 0.7), 1:]
train_y = train_data[:int(total * 0.7), 0]
test_x = train_data[int(total * 0.7):, 1:]
test_y = train_data[int(total * 0.7):, 0]
...
with open('train.prototxt', 'w') as f:
    f.write(str(lenet(train_lmdb_path, batch_size=75)))
